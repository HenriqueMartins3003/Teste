<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LogRegistry.aspx.cs" Inherits="_webPainelVerisys.ImportExport.LogRegistry" Culture="pt-BR" MasterPageFile="~/MP.Master"%>
<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="asp" %>

<asp:Content ID="cph_ImportExportLogRegistry" runat="server" ContentPlaceHolderID="ContentPlaceHolder">

<form id="frmImportExportLogRegistry" runat="server">
