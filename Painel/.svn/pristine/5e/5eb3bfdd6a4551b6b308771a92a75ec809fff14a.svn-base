...
{
    public partial class RamaisNaoGravam : System.Web.UI.Page
    {
        ...
        protected void gridLista()
        {
            ...
            DataSet dsQuery = objTelecom.listRamalNaoGrava();
            ...
            else
            {
                ...
                lblResponse.Text = "<div class='ROK'> Não existem Ramais Não Gravam Cadastrados !! </div>";
            }
        ...
        protected void gdRegistros_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            if (e.CommandName == "Del")
            {
                ...
                lblID.Text = gdRegistros.DataKeys[index]["RM"].ToString();
        ...
        {
            DataSet dsRegistros = objTelecom.listRamalNaoGrava();
        ...
        protected void Cadastro()
        {
            try
            {
                ...
                Int64 intResultado = objTelecom.ManagerRamalNaoGrava(objAuxTelecom, objUsers);
        ...
        protected void Exclusao()
        {
            try
            {
                ...
                objAuxTelecom.Ramal = lblID.Text;
