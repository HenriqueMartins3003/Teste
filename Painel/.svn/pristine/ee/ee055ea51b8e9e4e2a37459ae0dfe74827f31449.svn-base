<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RessubmissaoHistorico.aspx.cs" Inherits="_webPainelVerisys.Mailing.RessubmissaoHistorico" MasterPageFile="~/MP.Master"%>

<asp:Content ID="cph_RessubmissaoHistorico" runat="server" ContentPlaceHolderID="ContentPlaceHolder">

<form id="frmRessubmissaoHistorico" runat="server">
