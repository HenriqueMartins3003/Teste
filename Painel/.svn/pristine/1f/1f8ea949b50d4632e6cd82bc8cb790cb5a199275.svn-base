...
{
    public partial class RulesAfterProcess : System.Web.UI.Page
    {
        ...
        protected void listSegmenting()
        {
            ddlSegmentingID.DataSource = objImportExport.UINT_LISTSEGMENTING(ddlCampaign.SelectedValue);
            ddlSegmentingID.DataTextField = "NomeSegmentacao";
            ddlSegmentingID.DataValueField = "IDSegmentacao";
            ddlSegmentingID.DataBind();
            ddlSegmentingID.Items.Insert(0, new ListItem("Segmentacao ...", "0"));
        }
        ...
        protected void gdRegistros_Lista()
        {
            ...
            bfRulesID.ItemStyle.CssClass = "gridViewValues2";
            ...
            BoundField bfSegmentingID = new BoundField();
            bfSegmentingID.DataField = "SegmentingID";
            bfSegmentingID.HeaderText = "Segmentação";
            bfSegmentingID.HeaderStyle.CssClass = "gridViewHeader1";
            bfSegmentingID.ItemStyle.CssClass = "gridViewValues3";
            bfSegmentingID.ItemStyle.Width = 100;
            bfSegmentingID.Visible = true;
            bfSegmentingID.SortExpression = "SegmentingID";
            gdRegistros.Columns.Add(bfSegmentingID);
            ...
            DataSet dsQuery = objImportExport.UINT_LISTRULESAFTERPROCESS(objUsers);
        ...
        protected void gdRegistros_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            if (e.CommandName == "Upd")
            {
                ...
                listSegmenting();
                ddlSegmentingID.SelectedValue = gdRegistros.DataKeys[index]["SegmentingID"].ToString();
        ...
        {
            DataSet dsRegistros = objImportExport.UINT_LISTRULESAFTERPROCESS(objUsers);
        ...
        protected void Cadastro()
        {
            try
            {
                ...
                if (ddlSegmentingID.SelectedValue == "0")
                {
                    divResponse.Visible = true;
                    lblResponse.Text = "<div class='RNOK'>O Campo <b>Segmentação</b> deve ser selecionado !! </div>";
                    return;
                }

                dtoImportExport_RulesAfterProcess dtoAux = new dtoImportExport_RulesAfterProcess();
                dtoAux.Task = 1;
                ...
                dtoAux.SegmentingID = Convert.ToInt64(ddlSegmentingID.SelectedValue);
                dtoAux.RulesStatus = Convert.ToBoolean(ddlRulesStatus.SelectedValue.ToString());

                dtoResponse dtoResponse = objImportExport.UINT_MANAGER_RULESAFTERPROCESS(dtoAux, objUsers);
        ...
        protected void Limpar()
        {
            try
            {
                ...
                ddlSegmentingID.SelectedValue = "0";
