...
{
    public partial class ResultadoOperacaoCampanha_Fidelity : System.Web.UI.Page
    {
        ...
        {
            RO objRO = new RO();
            lbRO.DataSource = objRO.DatasetRO_Fidelity(IDCampanha, objUsers);
        ...
        {
            rModulos.DataSource = objROCampanha.listROConfiguration_Fidelity(IDCampanha, objUsers);
            rModulos.DataBind();
        }
        ...
        protected void AlteracaoReagendamento()
        {
            ...
            try
            {
                foreach (RepeaterItem ri in this.rModulos.Items)
                {
                    ...
                    CheckBox ckInvalidaTelefone = (CheckBox)ri.FindControl("chkInvalidaTelefone");
                    CheckBox ckFoneForcado = (CheckBox)ri.FindControl("chkFoneForcado");
                    TextBox txVision = (TextBox)ri.FindControl("txtVision");
                    CheckBox ckNotCallRec = (CheckBox)ri.FindControl("chkNotCallRec");
                    ...
                    objDtoRO.InvalidaTelefone = ckInvalidaTelefone.Checked == true ? true : false;
                    objDtoRO.FoneForcado = ckFoneForcado.Checked == true ? true : false;
                    objDtoRO.Vision = txVision.Text;
                    objDtoRO.NotCallRec = ckNotCallRec.Checked == true ? true : false;
        ...
        protected void chkInvalidaTelefoneTodos_CheckedChanged(object sender, EventArgs e)
        {
            if (chkInvalidaTelefoneTodos.Checked == true)
            {
                foreach (RepeaterItem ri in this.rModulos.Items)
                {
                    CheckBox ckBox = (CheckBox)ri.FindControl("chkInvalidaTelefone");
                    ckBox.Checked = true;
                }
            }
            else
        ...
        protected void chkFoneForcadoTodos_CheckedChanged(object sender, EventArgs e)
        {
            if (chkFoneForcadoTodos.Checked == true)
            {
                foreach (RepeaterItem ri in this.rModulos.Items)
                {
                    CheckBox ckBox = (CheckBox)ri.FindControl("chkFoneForcado");
                    ckBox.Checked = true;
                }
            }
            else
        ...
        protected void chkNotCallRecTodos_CheckedChanged(object sender, EventArgs e)
        {
            if (chkNotCallRecTodos.Checked == true)
            {
                foreach (RepeaterItem ri in this.rModulos.Items)
                {
                    CheckBox ckBox = (CheckBox)ri.FindControl("chkNotCallRec");
                    ckBox.Checked = true;
                }
            }
            else
