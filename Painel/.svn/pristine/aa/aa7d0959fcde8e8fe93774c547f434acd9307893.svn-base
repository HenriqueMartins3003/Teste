<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RulesCampaign.aspx.cs" Inherits="_webPainelVerisys.ImportExport.RulesCampaign" MasterPageFile="~/MP.Master"%>

<asp:Content ID="cph_ImportExportRulesCampaign" runat="server" ContentPlaceHolderID="ContentPlaceHolder">

<form id="frmImportExportRulesCampaign" runat="server">
        ...
        <div class="contentInside">
                ...
                <div class="ctt">
                    ...
                    <div id="ctnLista" runat="server">
                        <asp:GridView ID="gdRegistros" runat="server" 
                                ...
                                DataKeyNames="IDRulesCampaign, Campaign, TableColumn, Data"
            ...
            <div class="ctn" id="modManutencao" visible="true" runat="server">
                ...
                <div id="Div1" class="ctt" runat="server">
                    ...
                    <asp:label ID="lblTableColumn" CssClass="lb_Inside" Text="Coluna" runat="server" Width="100" ></asp:label>
                    <asp:TextBox ID="txtTableColumn" runat="server" CssClass="form" Width="200" MaxLength="200" ></asp:TextBox>
                    <br />
                    
                    <asp:label ID="lblData" CssClass="lb_Inside" Text="Conteúdo" runat="server" Width="100" ></asp:label>
                    <asp:TextBox ID="txtData" runat="server" CssClass="form" Width="200" MaxLength="200" ></asp:TextBox>
                    <br />
