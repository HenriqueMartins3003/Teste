<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Registry.aspx.cs" Inherits="_webPainelVerisys.ImportExport.Registry" MasterPageFile="~/MP.Master"%>

<asp:Content ID="cph_ImportExportRegistry" runat="server" ContentPlaceHolderID="ContentPlaceHolder">

<form id="frmImportExportRegistry" runat="server">
                ...
                <div class="ctt">
                    ...
                    <div id="ctnLista" runat="server">
                        <asp:GridView ID="gdRegistros" runat="server" 
                                ...
                                DataKeyNames="RegistryID, RegistryName, RegistrySeparator, RegistryLineSize, 
                                                RegistryInitialLine, RegistryStatus, RegistryStatusID"
            ...
            <div class="ctn" id="modManutencao" visible="true" runat="server">
                ...
                <div id="Div1" class="ctt" runat="server">
                    ...
                    <div id="Div3" class="contentBoxListsContentL" runat="server" style="height:80px; border:0px">
                        <asp:label ID="lblRegistryName" CssClass="lb_Inside" Text="Nome" runat="server" Width="100" ></asp:label>
                        <asp:TextBox ID="txtRegistryName" runat="server" CssClass="form" Width="200" MaxLength="200" ></asp:TextBox>
                        <br />
                        
                        <asp:label ID="lblRegistrySeparator" CssClass="lb_Inside" Text="Separador" runat="server" Width="100" ></asp:label>
                        <asp:TextBox ID="txtRegistrySeparator" runat="server" CssClass="form" Width="30" MaxLength="1" ></asp:TextBox>
                        <br />
                        
                        <asp:label ID="lblRegistryLineSize" CssClass="lb_Inside" Text="Tamanho" runat="server" Width="100" ></asp:label>
                        <asp:TextBox ID="txtRegistryLineSize" runat="server" CssClass="form" Width="50" MaxLength="12" ></asp:TextBox>
                    </div>
                    
                    <div id="Div4" class="contentBoxListsContentR" runat="server" style="height:80px; border:0px">
                       <%-- <asp:label ID="lblDefaultValue" CssClass="lb_Inside" Text="Texto Padrão" runat="server" Width="100" ></asp:label>
                        <asp:TextBox ID="txtDefaultValue" runat="server" CssClass="form" Width="120" MaxLength="12" ></asp:TextBox>
                        <br />--%>
                        <asp:label ID="lblRegistryInitialLine" CssClass="lb_Inside" Text="Linha" runat="server" Width="100" ></asp:label>
                        <asp:TextBox ID="txtRegistryInitialLine" runat="server" CssClass="form" Width="30" MaxLength="12" ></asp:TextBox>
                        <br />
                        
                        <asp:label ID="lblRegistryStatus" CssClass="lb_Inside" Text="Ativo ?" runat="server" Width="100"></asp:label>
                        <asp:DropDownList ID="ddlRegistryStatus" runat="server" CssClass="form" Width="205">
