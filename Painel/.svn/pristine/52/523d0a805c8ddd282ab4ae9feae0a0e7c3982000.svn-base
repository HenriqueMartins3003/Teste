<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Produto_Affinity.aspx.cs" Inherits="_webPainelVerisys.FrontEnd.Produto_Affinity" MasterPageFile="~/MP.Master"%>

<asp:Content ID="cph_ProdutoAffinity" runat="server" ContentPlaceHolderID="ContentPlaceHolder">

<form id="frmProdutoAffinity" runat="server">
    <div class="containerInside">
        ...
        <div class="titleContentInside">Produto - Affinity</div>
        ...
        <div class="contentInside"  id=divContent visible="false" runat="server">
            ...
            <div class="ctn" id="modLista" runat="server" visible="true">
                <div class="cttTitle"><b>Produtos Cadastrados</b></div>
                ...
                <div class="ctt">
                    ...
                    <div id="ctnLista" runat="server">
                        <asp:GridView ID="gdRegistros" runat="server" 
                                ...
                                DataKeyNames="IDPRODUTO, DESCRICAOPRODUTO, CAMPANHAMAILING, IDCAMPANHA, FLAG_ATIVO"
            ...
            <div class="ctn" id="modManutencao" visible="true" runat="server">
                ...
                <div class="cttTitle">
                    ...
                    <div style="float:left;"><b>
                        <asp:Label ID="lblTituloDiv" runat="server" Text="Cadastrar novo Produto"></asp:Label></b>
                ...
                <div id="Div1" class="ctt" runat="server">
                    ...
                    <asp:TextBox ID="txtProduto" runat="server" CssClass="form" Width="500"></asp:TextBox>
                    
                    <br />
                    <asp:label ID="lblCampanhaMailing" CssClass="lb_Inside" Text="Camp.Mailing" runat="server"></asp:label>
                    <asp:TextBox ID="txtCampanhaMailing" runat="server" CssClass="form" Width="500"></asp:TextBox>
                    
                    <br />
                    <asp:label ID="lblCampanhaCadastro" CssClass="lb_Inside" Text="Campanha" runat="server"></asp:label>
                    <asp:DropDownList ID="ddlCampanhaCadastro" runat="server" CssClass="form" Width="100"></asp:DropDownList>
            ...
            <div class="ctn" id="modExcluir" visible="false" runat="server">
                ...
                <div class="cttTitle">
                    ...
                    <div style="float:left;"><b>
                        <asp:Label ID="lblExluir" runat="server" Text="Excluir Produto"></asp:Label></b>
                    </div>
                ...
                <div id="Div2" class="ctt" runat="server">
                    ...
                    <center>
                    <asp:label ID="lblMensagemExclusao" Text="Confirma a exclusão do Produto :" runat="server"></asp:label>
                    <br /><br />
