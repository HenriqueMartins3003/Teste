<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ResultadoOperacaoCampanha.aspx.cs" Inherits="_webPainelVerisys.ResultadoOperacao.ResultadoOperacaoCampanha" MasterPageFile="~/MP.Master"%>

<asp:Content ID="cph_ResultadoOperacaoCampanha" runat="server" ContentPlaceHolderID="ContentPlaceHolder">

<form id="frmResultadoOperacaoCampanha" runat="server">
                ...
                <table cellpadding="0" cellspacing="0" border="0" class="odd" width="100%">
                    <thead style="background:#F1F1F1;">
                        <tr>
                            ...
                            <td align="center" valign="middle" style="padding:5px 3px; width:100px;"><b>
                                <asp:CheckBox ID="chkReagEspecificoTodos" runat="server" Checked="false" 
                                    AutoPostBack="true" oncheckedchanged="chkReagEspecificoTodos_CheckedChanged"/>&nbsp;&nbsp;ReagEspecifico</b></td>
                            
                            <td align="center" valign="middle" style="padding:5px 3px; width:150px;"><b>Tempo Retorno</b></td>
                        </tr>
                    </thead>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td style="padding:5px 5px;" align="center" valign="middle">
                                <asp:CheckBox ID="chkReagEspecifico" runat="server" Checked=<%# Convert.ToBoolean(Eval("ReagendamentoEspecificoRO")) %> /></td>

                            <td style="padding:5px 5px;" align="center" valign="middle">
                                <asp:TextBox ID="txtTempoRetorno" runat="server" CssClass="form" Width="50px" Text=<%# Eval("TempoReagendamentoRO") %> /></td>
                        </tr>
                        </ItemTemplate>
                        </asp:Repeater>
                    </tbody>
