<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ResultadoOperacaoTipo.aspx.cs" Inherits="_webPainelVerisys.ResultadoOperacao.ResultadoOperacaoTipo"  MasterPageFile="~/MP.Master"%>

<asp:Content ID="cph_ResultadoOperacaoTipo" runat="server" ContentPlaceHolderID="ContentPlaceHolder">

<form id="frmResultadoOperacaoTipo" runat="server">
    <div class="containerInside">
        ...
        <div class="titleContentInside">Tipo de Resultado da Operação</div>
        ...
        <div class="contentInside"  id=divROContent visible="false" runat="server">
            ...
            <div class="ctn" id="modListaRO" runat="server" visible="true">
                <!-- title[1] -->
                <div class="cttTitle"><b>Tipos Cadastrados</b></div>
                ...
                <div class="ctt">
                    ...
                    <div id="ctnListaTipoRO" runat="server">
                        <asp:GridView ID="gdRegistros" runat="server" 
                                ...
                                DataKeyNames="ID_TIPO_RO, DESCRICAO"
            ...
            <!-- RO -->
            <div class="ctn" id="modManutencaoTipoRO" visible="true" runat="server">
                <!-- title -->
                <div class="cttTitle">

                    <div style="float:left;"><b>
                        <asp:Label ID="lblTituloDiv" runat="server" Text="Cadastrar novo Tipo de Resultado da Operação"></asp:Label></b>
                        <asp:Label ID="lblIDTipoRO" runat="server" Text="" Visible="false"></asp:Label></b>
                    </div>
            ...
            <div class="ctn" id="modExcluirTipoRO" visible="false" runat="server">
                <!-- title -->
                <div class="cttTitle">

                    <div style="float:left;"><b>
                        <asp:Label ID="lblExluirTipoRO" runat="server" Text="Excluir Tipo de Resultado da Operação"></asp:Label></b>
                    </div>
                ...
                <div id="Div2" class="ctt" runat="server">
                    ...
                    <center>
                    <asp:label ID="lblMensagemExclusao" Text="Confirma a exclusão do Tipo de Resultado da Operação :" runat="server"></asp:label>
                    <br /><br />
                    <asp:label ID="lblTipoROExclusao" CssClass="lb_InsideConfirm" Text="" runat="server"></asp:label>
                    </center>
