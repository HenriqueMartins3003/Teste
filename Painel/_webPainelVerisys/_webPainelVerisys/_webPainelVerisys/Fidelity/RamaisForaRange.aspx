<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RamaisForaRange.aspx.cs" Inherits="_webPainelVerisys.Fidelity.RamaisForaRange" MasterPageFile="~/MP.Master"%>

<asp:Content ID="cph_RamaisNaoGravam" runat="server" ContentPlaceHolderID="ContentPlaceHolder">

<form id="frmRamaisForaRange" runat="server">
    <div class="containerInside">
        ...
        <div class="titleContentInside">Ramais Fora Range</div>
        ...
        <div class="contentInside">
            ...
            <div class="ctn" id="modLista" runat="server" visible="true">
                <!-- title[1] -->
                <div class="cttTitle"><b>Ramais Fora Range Cadastrados</b></div>
