<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Parcelamento_Affinity.aspx.cs" Inherits="_webPainelVerisys.FrontEnd.Parcelamento_Affinity" MasterPageFile="~/MP.Master"%>

<asp:Content ID="cph_ParcelamentoAffinity" runat="server" ContentPlaceHolderID="ContentPlaceHolder">

<form id="frmParcelamentoAffinity" runat="server">
    <div class="containerInside">
        ...
        <div class="titleContentInside">Parcelamento - Affinity</div>
        ...
        <div class="contentInside"  id=divContent visible="false" runat="server">
            ...
            <div class="ctn" id="modLista" runat="server" visible="true">
                <div class="cttTitle"><b>Parcelamentos Cadastrados</b></div>
                ...
                <div class="ctt">
                    ...
                    <div id="ctnLista" runat="server">
                        <asp:GridView ID="gdRegistros" runat="server" 
                                ...
                                DataKeyNames="CODIGO, TIPOPARCELAMENTO, IDPRODUTO, DESCRICAOPRODUTO, FLAG_ATIVO"
            ...
            <div class="ctn" id="modManutencao" visible="true" runat="server">
                ...
                <div class="cttTitle">
                    ...
                    <div style="float:left;"><b>
                        <asp:Label ID="lblTituloDiv" runat="server" Text="Cadastrar novo Parcelamento"></asp:Label></b>
                ...
                <div id="Div1" class="ctt" runat="server">
                    ...
                    <asp:label ID="lblTipoParcelamento" CssClass="lb_Inside" Text="Parcelamento" runat="server"></asp:label>
                    <asp:TextBox ID="txtTipoParcelamento" runat="server" CssClass="form" Width="500"></asp:TextBox>

                    <br />
                    
                    <asp:label ID="lblProduto" CssClass="lb_Inside" Text="Produto" runat="server"></asp:label>
                    <asp:DropDownList ID="ddlProduto" runat="server" CssClass="form" Width="200"></asp:DropDownList>
                    <br />
            ...
            <div class="ctn" id="modExcluir" visible="false" runat="server">
                ...
                <div class="cttTitle">
                    ...
                    <div style="float:left;"><b>
                        <asp:Label ID="lblExluir" runat="server" Text="Excluir Parcelamento"></asp:Label></b>
                    </div>
                ...
                <div id="Div2" class="ctt" runat="server">
                    ...
                    <center>
                    <asp:label ID="lblMensagemExclusao" Text="Confirma a exclusão do Parcelamento :" runat="server"></asp:label>
                    <br /><br />
