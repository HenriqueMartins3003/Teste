<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TipoMeioCobranca_Affinity.aspx.cs" Inherits="_webPainelVerisys.FrontEnd.TipoMeioCobranca_Affinity" MasterPageFile="~/MP.Master"%>

<asp:Content ID="cph_TipoMeioCobrancaAffinity" runat="server" ContentPlaceHolderID="ContentPlaceHolder">

<form id="frmTipoMeioCobrancaAffinity" runat="server">
    <div class="containerInside">
        ...
        <div class="titleContentInside">Tipos de Meios de Cobrança - Affinity</div>
        ...
        <div class="contentInside"  id=divContent visible="false" runat="server">
            ...
            <div class="ctn" id="modLista" runat="server" visible="true">
                <div class="cttTitle"><b>Tipos de Meios de Cobrança Cadastrados</b></div>
                ...
                <div class="ctt">
                    ...
                    <div id="ctnLista" runat="server">
                        <asp:GridView ID="gdRegistros" runat="server" 
                                ...
                                DataKeyNames="IDTIPOMEIOCOBRANCA, DESCRICAOTIPOMEIOCOBRANCA, FLAG_ATIVO"
            ...
            <div class="ctn" id="modManutencao" visible="true" runat="server">
                ...
                <div class="cttTitle">
                    ...
                    <div style="float:left;"><b>
                        <asp:Label ID="lblTituloDiv" runat="server" Text="Cadastrar novo Tipo de Meio de Cobranca"></asp:Label></b>
                ...
                <div id="Div1" class="ctt" runat="server">
                    ...
                    <asp:label ID="lblTipoMeioCobranca" CssClass="lb_Inside" Text="Tipo de Meio de Cobranca" runat="server"></asp:label>
                    <asp:TextBox ID="txtTipoMeioCobranca" runat="server" CssClass="form" Width="500"></asp:TextBox>
            ...
            <div class="ctn" id="modExcluir" visible="false" runat="server">
                ...
                <div class="cttTitle">
                    ...
                    <div style="float:left;"><b>
                        <asp:Label ID="lblExluir" runat="server" Text="Excluir Tipo de Meio de Cobranca"></asp:Label></b>
                    </div>
                ...
                <div id="Div2" class="ctt" runat="server">
                    ...
                    <center>
                    <asp:label ID="lblMensagemExclusao" Text="Confirma a exclusão do Tipo de Meio de Cobranca :" runat="server"></asp:label>
                    <br /><br />
