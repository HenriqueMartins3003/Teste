<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TipoPlano_Affinity.aspx.cs" Inherits="_webPainelVerisys.FrontEnd.TipoPlano_Affinity" MasterPageFile="~/MP.Master"%>

<asp:Content ID="cph_TipoPlanoAffinity" runat="server" ContentPlaceHolderID="ContentPlaceHolder">

<form id="frmTipoPlanoAffinity" runat="server">
    <div class="containerInside">
        ...
        <div class="titleContentInside">Tipos de Planos - Affinity</div>
        ...
        <div class="contentInside"  id=divContent visible="false" runat="server">
            ...
            <div class="ctn" id="modLista" runat="server" visible="true">
                <div class="cttTitle"><b>Tipos de Planos Cadastrados</b></div>
                ...
                <div class="ctt">
                    ...
                    <div id="ctnLista" runat="server">
                        <asp:GridView ID="gdRegistros" runat="server" 
                                ...
                                DataKeyNames="IDTIPOPLANO, TIPOPLANO, FLAG_ATIVO"
            ...
            <div class="ctn" id="modManutencao" visible="true" runat="server">
                ...
                <div class="cttTitle">
                    ...
                    <div style="float:left;"><b>
                        <asp:Label ID="lblTituloDiv" runat="server" Text="Cadastrar novo Tipo de Plano"></asp:Label></b>
                ...
                <div id="Div1" class="ctt" runat="server">
                    ...
                    <asp:label ID="lblTipoPlano" CssClass="lb_Inside" Text="Tipo de Plano" runat="server"></asp:label>
                    <asp:TextBox ID="txtTipoPlano" runat="server" CssClass="form" Width="500"></asp:TextBox>
            ...
            <div class="ctn" id="modExcluir" visible="false" runat="server">
                ...
                <div class="cttTitle">
                    ...
                    <div style="float:left;"><b>
                        <asp:Label ID="lblExluir" runat="server" Text="Excluir Tipo de Plano"></asp:Label></b>
                    </div>
                ...
                <div id="Div2" class="ctt" runat="server">
                    ...
                    <center>
                    <asp:label ID="lblMensagemExclusao" Text="Confirma a exclusão do Tipo de Plano :" runat="server"></asp:label>
                    <br /><br />
