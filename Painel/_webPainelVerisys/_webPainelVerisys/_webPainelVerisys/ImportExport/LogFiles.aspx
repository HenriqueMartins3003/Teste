<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LogFiles.aspx.cs" Inherits="_webPainelVerisys.ImportExport.LogFiles" Culture="pt-BR" MasterPageFile="~/MP.Master"%>
<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="asp" %>

<asp:Content ID="cph_ImportExportLogFiles" runat="server" ContentPlaceHolderID="ContentPlaceHolder">

<form id="frmImportExportLogFiles" runat="server">
    <div class="containerInside">

<%--henrique vai trabalhar nesta tela--%>
        ...
        <div class="contentInside" id=divContent runat="server">
            <div class="cttTitle"><b>Filtro de Pesquisa (Atual)</b></div>
            ...
            <div class="ctn" id="divPesquisa" runat="server">
                ...
                <div id="Div1" class="contentBoxListsContentL" runat="server" style="height:80px; border:0px">
                    ...
                    <asp:Label ID="lblProcessID0" runat="server" CssClass="lb_Inside" 
                        Text="Arquivo" Width="100px"></asp:Label>
                    <asp:TextBox ID="txtArquivo" runat="server" CssClass="form"></asp:TextBox>
        ...
        <div class="contentInside" id=divGridContent visible="false" runat="server">
