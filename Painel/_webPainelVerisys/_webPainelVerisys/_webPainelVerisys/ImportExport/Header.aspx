<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Header.aspx.cs" Inherits="_webPainelVerisys.ImportExport.Header" MasterPageFile="~/MP.Master"%>

<asp:Content ID="cph_ImportExportHeader" runat="server" ContentPlaceHolderID="ContentPlaceHolder">

<form id="frmImportExportHeader" runat="server">
                ...
                <div class="ctt">
                    ...
                    <div id="ctnLista" runat="server">
                        <asp:GridView ID="gdRegistros" runat="server" 
                                ...
                                DataKeyNames="HeaderID, HeaderName, HeaderSeparator, HeaderLineSize, HeaderInitialLine, HeaderStatus, HeaderStatusID"
            ...
            <div class="ctn" id="modManutencao" visible="true" runat="server">
                ...
                <div id="Div1" class="ctt" runat="server">
                    ...
                    <div id="Div3" class="contentBoxListsContentL" runat="server" style="height:80px; border:0px">
                        <asp:label ID="lblHeaderName" CssClass="lb_Inside" Text="Nome" runat="server" Width="100"></asp:label>
                        <asp:TextBox ID="txtHeaderName" runat="server" CssClass="form" Width="200" MaxLength="200" ></asp:TextBox>
                        <br />
                        
                        <asp:label ID="lblHeaderSeparator" CssClass="lb_Inside" Text="Separador" runat="server" Width="100"></asp:label>
                        <asp:TextBox ID="txtHeaderSeparator" runat="server" CssClass="form" Width="30" MaxLength="1" ></asp:TextBox>
                        <br />
                        
                        <asp:label ID="lblHeaderLineSize" CssClass="lb_Inside" Text="Tamanho" runat="server" Width="100"></asp:label>
                        <asp:TextBox ID="txtHeaderLineSize" runat="server" CssClass="form" Width="30" MaxLength="12" ></asp:TextBox>
                    </div>
                    
                    <div id="Div4" class="contentBoxListsContentR" runat="server" style="height:80px; border:0px">
                        <asp:label ID="lblHeaderInitialLine" CssClass="lb_Inside" Text="Linha" runat="server" Width="100"></asp:label>
                        <asp:TextBox ID="txtHeaderInitialLine" runat="server" CssClass="form" Width="30" MaxLength="12" ></asp:TextBox>
                        <br />
                        
                        <asp:label ID="lblHeaderStatus" CssClass="lb_Inside" Text="Ativo ?" runat="server" Width="100"></asp:label>
                        <asp:DropDownList ID="ddlHeaderStatus" runat="server" CssClass="form" Width="205">
