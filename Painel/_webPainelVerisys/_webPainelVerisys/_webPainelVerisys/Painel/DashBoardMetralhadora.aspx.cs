...
{
    public partial class DashBoardMetralhadora : System.Web.UI.Page
    {
        ...
        private void AccessSecurity()
        {
            if (objUsersProfiles.AccessProfile("boxMailing", dtoUsersProfiles.AccessType.CONSULTA, objUsers.IdProfile) == 0)
            {
                ...
                boxMailingMetralhadora.Visible = false;
                cb_Mailing.Visible = false;
                boxMailingChartMetralhadora.Visible = false;
            }
            else
            {
                boxMailingMetralhadora.Visible = true;
                cb_Mailing.Visible = true;
                boxMailingChartMetralhadora.Visible = true;
            }

            if (objUsersProfiles.AccessProfile("boxChamadasDia", dtoUsersProfiles.AccessType.CONSULTA, objUsers.IdProfile) == 0)
            {
                boxChamadasDiaMetralhadora.Visible = false;
                cb_ChamadasTotal.Visible = false;
                boxChamadasDiaChartMetralhadora.Visible = false;
            }
            else
            {
                boxChamadasDiaMetralhadora.Visible = true;
                cb_ChamadasTotal.Visible = true;
                boxChamadasDiaChartMetralhadora.Visible = true;
            }

            if (objUsersProfiles.AccessProfile("boxUltimasChamadas", dtoUsersProfiles.AccessType.CONSULTA, objUsers.IdProfile) == 0)
            {
                boxUltimasChamadasMetralhadora.Visible = false;
                cb_ChamadasUltMin.Visible = false;
                boxUltimasChamadasChartMetralhadora.Visible = false;
            }
            else
            {
                boxUltimasChamadasMetralhadora.Visible = true;
                cb_ChamadasUltMin.Visible = true;
                boxUltimasChamadasChartMetralhadora.Visible = true;
            }

            if (objUsersProfiles.AccessProfile("boxRO", dtoUsersProfiles.AccessType.CONSULTA, objUsers.IdProfile) == 0)
            {
                boxROMetralhadora.Visible = false;
                cb_RO.Visible = false;
            }
            else
            {
                boxROMetralhadora.Visible = true;
                cb_RO.Visible = true;
            }
        }
