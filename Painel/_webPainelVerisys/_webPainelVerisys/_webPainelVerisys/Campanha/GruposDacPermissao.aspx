-<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GruposDacPermissao.aspx.cs" Inherits="_webPainelVerisys.Campanha.GruposDacPermissao" MasterPageFile="~/MP.Master" %>

<asp:Content ID="cph_GrupoDacPermissao" runat="server" ContentPlaceHolderID="ContentPlaceHolder">
    <form id="frmGrupoDacPermissao" runat="server">
        ...
        <div class="contentInside">
                    ...
                    <div id="ctnLista" runat="server">
                        <asp:GridView ID="gdRegistros" runat="server" 
                           AllowSorting="True"
                                ...
                                AllowPaging="True"
                                PageSize="20"
                                DataKeyNames="IDGrupoDACRestricao,GrupoDAC,IDType,Classificacao"
            ...
            <div class="ctn" id="modManutencao" visible="true" runat="server">
                ...
                <div id="Div2" class="ctt" runat="server">
                     <asp:label ID="lblGrupoDac" CssClass="lb_Inside" Text="Grupo DAC" runat="server" Width="100"></asp:label>
                    <asp:DropDownList ID="ddlGrupoDac" runat="server" CssClass="form" Width="205"></asp:DropDownList>
                     <br />

                    <asp:label ID="lblPhoneType" CssClass="lb_Inside" Text="Tipo" runat="server" Width="100"></asp:label>
                    <asp:DropDownList ID="ddlPhoneType" runat="server" CssClass="form" Width="205"></asp:DropDownList>
                     <br />

                    <asp:label ID="lblPhoneClassification" CssClass="lb_Inside" Text="Classificação" runat="server" Width="100"></asp:label>
                    <asp:DropDownList ID="ddlPhoneClassification" runat="server" CssClass="form" Width="205"></asp:DropDownList>
                   <p>
                </p>
