...
$strings["noti_memberactivation2"] = "Вы только что добавлены в систему управления клиента SGD.  Эта система разработана и непрерывно модернизироваться для того, чтобы помогать Вам, как клиенту, быть в курсе Вашего проекта.\n\nДля входа в систему, откройте браузер (предподтительно Internet Explorer 6.x или Netscape 7.x) и введите следующее:";
