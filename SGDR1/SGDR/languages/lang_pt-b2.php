...
$status = array(0 => "Finalizado pelo Cliente", 1 => "Em Analise", 2 => "Não Iniciado", 3 => "Aberto", 4 => "Validado pelo Relacionamento", 5 => "Validado pela TI", 6 => "Em Andamento", 7 => "Aguardando Homologação", 8 => "Aceite pelo Cliente", 9 => "Homologação com Pedência",  10 => "Em Produção" ,  11 => "Cancela",  12 => "Pendente");
...
$strings["my_demandas"] = "Indentificação da Demanda";
...
$strings["resp_relaciona"] = "Resp. Relacinamento";
$strings["dt_inicop"] = "Inicio Planejado";
$strings["dt_inicre"] = "Inicio Realizado";
$strings["dt_fimcop"] = "Fim Planejado";
$strings["dt_fimre"] = "Fim Realizado";
$strings["justifica"] = "Justifica";
$strings["smudanca"] = " Mudança";
$strings["so_mudanca"] = "Solicitação de Mudança";
