...
if ($_REQUEST['unc'] != "") {
	$_SESSION['id_unidade'] = $_REQUEST['unc'];
} else {
	$_SESSION['id_unidade'];
}
if ($_REQUEST['si'] != "") {
...
if ($_REQUEST['tipo_demanda'] != "") {
	$_SESSION['id_tipo_demanda'] = $_REQUEST['tipo_demanda'];
} else {
	$_SESSION['id_tipo_demanda'];
}
if ($_REQUEST['an'] != "") {
...
$block1->form = "saP";
$block1->openForm("../reports/listprojects?typeProjects=$typeProjects&" . session_name() . "=" . session_id() . "#" . $block1->form . "Anchor");
...
//echo "&nbsp;&nbsp;&nbsp;".$block1->buildLink("../projects/listprojects.php?situa=11","Demandas Canceladas",in);
